...
public class LevelTwo extends World
{
    ...
    public LevelTwo()
    {
        ...
        y = new Collectible();
        addObject(y,144+30, 372-y.getHeight());
    ...
    /**
     * Sets gameOver as current world if instance variable lives is
     * equal to zero
    ...
    public void act()
    {
        if(cat.getLives() == 0){
            ...
            World level3 = new LevelThree();
            Mayflower.setWorld(level3);
        }
    }
}